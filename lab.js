...
let cat = new Cat('Mittens', 5, 'Gray')
...
//Code Here
const myPhone = new Phone('Apple', 'iPhone 14', '128GB', 'black', 999.99);
...
//Code Here
let vehicle = new Vehicle(4, 'black', 200)
console.log(vehicle)
...
//Code Here 
let motorcycle = new Motorcycle(1, 'blue', 150, 'Yamaha', false)
...
//Code Here
let boat = new Boat(100, 'red', 20, 'Tyla', 'dingy', false)
